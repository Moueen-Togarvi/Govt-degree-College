...
<section class="relative overflow-hidden bg-white py-18 lg:py-24">
	...
	<div class="container relative z-10 mx-auto px-4 lg:px-8">
		<div class="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
			<div class="relative mx-auto w-full max-w-md lg:max-w-none">
				...
				<div class="absolute inset-x-4 bottom-4 mx-auto max-w-[calc(100%-2rem)] rounded-[1.5rem] border border-white/20 bg-primary/90 px-5 py-4 text-center text-white shadow-2xl shadow-primary/30 backdrop-blur sm:bottom-8 sm:left-0 sm:right-8 sm:max-w-xs sm:px-6 sm:py-5 sm:text-left">
					<div class="mb-3 flex items-center justify-center gap-2 text-secondary sm:justify-start">
						<ShieldCheck size={18} />
						<span class="text-xs font-black uppercase tracking-[0.28em]">Accessible Learning</span>
					</div>
					<p class="text-base font-black leading-7 sm:text-lg">Education from intermediate to BS level with a public-sector foundation.</p>
				</div>
			</div>
			...
			<div class="space-y-8 text-center lg:text-left">
				<div class="space-y-4">
					...
					<p class="mx-auto max-w-2xl text-base font-medium leading-8 text-primary/65 lg:mx-0 lg:text-lg">
				...
				<div class="relative overflow-hidden rounded-[2rem] border border-border-soft bg-neutral-soft/80 p-6 shadow-[0_20px_60px_rgba(13,93,86,0.08)] sm:p-8">
					<Quote size={42} class="mx-auto mb-5 text-secondary/70 lg:mx-0" />
				...
				<a href="/about/administration" class="group inline-flex items-center justify-center gap-3 font-black text-primary transition-all hover:text-secondary lg:justify-start">
					Read Full Biography
