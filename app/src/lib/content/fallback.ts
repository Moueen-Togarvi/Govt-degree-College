...
export const fallbackAnnouncements: Announcement[] = [
	{
		...
		description:
			'Admissions are now open for 11th class. Students can submit their documents and application forms through the college admission office.',
		category: 'Admissions'
	},
	{
		id: 2,
		...
		description:
			'Admissions are open for BS programs affiliated with KFUEIT in both morning and evening shifts. Contact the college for eligibility and fee details.',
		category: 'Admissions'
	},
	{
		id: 3,
		...
		description:
			'Applicants for 11th and 12th classes should bring their previous academic documents and passport-size photographs at the time of submission.',
		category: 'Notice'
	}
];

export const fallbackTickerAnnouncements: LatestNewsItem[] = [
	{
		id: 1,
...
export const fallbackNoticeBoardItems: NoticeBoardItem[] = [
	{
		id: 1,
