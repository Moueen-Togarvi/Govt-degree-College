...
<div class="adm-page">
	<div class="adm-head">
		<div>
			<h1 class="adm-title">📰 News Ticker</h1>
			<p class="adm-sub">
				Short headlines that scroll in the homepage ticker. Each links to the announcements page.
			</p>
		</div>
		<button class="adm-btn adm-btn--primary" onclick={openCreate}>+ New Headline</button>
	</div>
	...
	<div class="adm-overlay" onclick={closeModal} role="presentation">
		...
		>
			<div class="adm-modal__head">
				<h2 class="adm-modal__title">{editing ? '✏️ Edit Headline' : '📰 New Headline'}</h2>
