		...
		<table class="table">
			...
			<tbody>
				{#if data.documents.length === 0}
					<tr><td colspan="5" class="py-8 text-center">No documents available.</td></tr>
				{:else}
					{#each data.documents as doc}
						<tr>
							<td>
								<div class="flex items-center gap-3">
									...
									<div>
										...
										<div class="text-xs tracking-wider text-slate-500 uppercase">
							...
							<td>
								{#if doc.course_code}
									<div class="badge-blue mb-1 font-mono">{doc.course_code}</div>
