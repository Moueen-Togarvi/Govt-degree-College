		...
		<div class="controls">
			...
			<div class="control-group">
				...
				<div class="view-toggle">
					<button
						class="view-btn {view === 'mark' ? 'active' : ''}"
						onclick={() => {
							view = 'mark';
							navigate();
						}}>Mark</button
					>
					<button
						class="view-btn {view === 'summary' ? 'active' : ''}"
						onclick={() => {
							view = 'summary';
							navigate();
						}}>Summary</button
					...
					{:else}
						{#each data.summary as s, i}
							<tr>
								...
								<td class="text-green text-center">{s.present}</td>
								<td class="text-red text-center">{s.absent}</td>
								<td class="text-orange text-center">{s.late}</td>
								<td class="text-center">
									<span
										class="percent-badge {s.percentage >= 75
											? 'good'
											: s.percentage >= 60
												? 'warn'
												: 'bad'}"
