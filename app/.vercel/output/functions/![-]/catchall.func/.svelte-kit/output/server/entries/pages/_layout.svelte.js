...
function Navbar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<nav${attr_class(`fixed top-0 z-50 w-full transition-all duration-500 ${stringify("")}`)}><div data-nav-topbar="" class="hidden lg:block bg-primary text-white/90 py-2 border-b border-white/10 overflow-hidden"><div class="container mx-auto px-4 lg:px-8 flex justify-between items-center text-xs font-medium"><div class="flex items-center gap-6"><div class="flex items-center gap-2">`);
		Phone_call($$renderer, {
			size: 14,
		...
		$$renderer.push(`<!--]--> <div class="ml-6 flex items-center gap-3 pl-8 border-l border-neutral-200"><a data-nav-cta="" href="/student-portal" class="flex items-center gap-2 px-7 py-3 rounded-xl text-sm font-black text-white bg-secondary hover:bg-secondary/90 hover:scale-105 hover:shadow-lg hover:shadow-secondary/20 transition-all active:scale-95 uppercase tracking-widest">`);
...
function Footer($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!----> <p class="text-sm">Govt Post Graduate College, College Road, Bahawalnagar, Punjab, Pakistan</p></div> <div class="flex items-center gap-4 text-white/70">`);
		Phone($$renderer, {
			size: 20,
			class: "text-secondary flex-shrink-0"
		});
