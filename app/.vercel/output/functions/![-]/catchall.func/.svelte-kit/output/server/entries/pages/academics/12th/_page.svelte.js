...
//#region src/routes/academics/12th/+page.svelte
function _page($$renderer) {
	...
	head("1ymm4qf", $$renderer, ($$renderer) => {
		$$renderer.title(($$renderer) => {
			$$renderer.push(`<title>12th Class (Inter Part-II) | GPGC Bahawalnagar</title>`);
		});
	});
	PageHero($$renderer, {
		title: "Intermediate Part-II",
		subtitle: "Achieve excellence in your final year of college education.",
		breadcrumbs,
